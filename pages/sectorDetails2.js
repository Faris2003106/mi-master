...
const cards =[
    {icon: <FontAwesomeIcon icon={faListUl}/>, nums: '465', title: 'إجمالي عدد الأنشطة التجارية'},
    {icon: <FontAwesomeIcon icon={faChartSimple}/>, nums: '%0.5', title: ' النسبة المئوية لعدد الأنشطة للربع الثالث من عام 2023م'},
    {icon: <FontAwesomeIcon icon={faLineChart}/>, nums: '%11', title: 'معدل التغير السنوي للنشاط'},
    {icon: <FontAwesomeIcon icon={faUser}/>, nums: '22', title: 'معدل الأنشطة للسكان', paragraph: 'لكل 100 ألف نسمة'}
]


export default function SectorDetails2(){
    ...
    return(
        ...
        <div className="pt-36 mb-24 pr-20 pl-20">
            <div className="text-right">
                <h1 className="font-bold text-2xl leading-8	text-[#007d56]">الأنشطة الزراعية
                <span className="block w-4 h-4 bg-green-700 rounded-full absolute mt-3"></span>
                <hr className="w-32 mt-5 mr-0"/>
                </h1>
                <p className="text-[#686868] mt-5 text-sm font-thin">
